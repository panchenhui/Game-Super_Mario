...
{
    public class Level1_4SlopeClass : IBlock
    {
        ...
        public Level1_4SlopeClass(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new Level1_4SlopeSprite(Mygame.fragementBrick);
