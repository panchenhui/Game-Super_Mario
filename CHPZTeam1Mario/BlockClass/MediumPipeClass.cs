...
namespace CHPZTeam1Mario.BlockClass
{
    class MediumPipeClass:IBlock
    {
        ...
        public MediumPipeClass(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new MediumPipeSprite(Mygame.pipes);
            this.rectangle = new Rectangle((int)position.X, (int)position.Y, 64, 96);
        }
