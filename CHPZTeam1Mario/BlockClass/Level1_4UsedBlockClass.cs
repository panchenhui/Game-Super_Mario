...
{
    public class Level1_4UsedBlockClass : IBlock
    {
        ...
        public Level1_4UsedBlockClass(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new Level1_4UsedBlockSprite(Mygame.blocks);
