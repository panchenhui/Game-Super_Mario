...
{
    public class Level1_4Bridge2Class : IBlock
    {
        ...
        public Level1_4Bridge2Class(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new Level1_4BridgeSprite2(Mygame.fragementBrick);
