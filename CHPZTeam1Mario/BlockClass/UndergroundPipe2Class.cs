...
{
    public class UndergroundPipe2Class : IBlock
    {
        ...
        public UndergroundPipe2Class(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new UndergroundPipe2Sprite(Mygame.pipes);
            this.rectangle = new Rectangle((int)position.X, (int)position.Y, 56, 256);
        }
