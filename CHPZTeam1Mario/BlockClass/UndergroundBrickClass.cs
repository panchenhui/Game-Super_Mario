...
{
    public class UndergroundBrickClass : IBlock
    {
        ...
        public UndergroundBrickClass(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new UndergroundBrickSprite(Mygame.blocks);
