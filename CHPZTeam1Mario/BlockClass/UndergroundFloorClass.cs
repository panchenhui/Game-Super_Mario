...
{
    public class UndergroundFloorClass : IBlock
    {
        ...
        public UndergroundFloorClass(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new UndergroundFloorSprite(Mygame.blocks);
