...
{
    public class CastleClass: IBlock
    {
        ...
        public CastleClass(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new CastleSprite(Mygame.pipes);
            this.rectangle = new Rectangle((int)position.X, (int)position.Y, 80, 79);
        }
        public void Shake()
        {
