...
{
    public class Level1_4Bridge1Class : IBlock
    {
        ...
        public Level1_4Bridge1Class(SuperMario game, Vector2 position)
        {
            this.Mygame = game;
            this.Sprite = new Level1_4BridgeSprite(Mygame.blocks);
