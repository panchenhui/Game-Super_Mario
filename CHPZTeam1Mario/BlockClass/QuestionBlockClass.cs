...
{
    public class QuestionBlockClass : IBlock
    {
        ...
        public void Used()
        {
            if (!used)
            {
                ...
                if (ItemNumber > 0)
                {
                    ...
                    else if(Itemtype.Equals(Enum.Itemtype.Flower))
                    {
                        Sound.Instance.PowerupAppears();
                    }
                    else if (Itemtype.Equals(Enum.Itemtype.RedMushroom))
                    {
                        Sound.Instance.PowerupAppears();
                    }
                    else if (Itemtype.Equals(Enum.Itemtype.GreenMushroom))
                    {
                        Sound.Instance.PowerupAppears();
                    }
                }
